...
The vertical bar means "assuming or conditional on", similar to the notation you would see in conditional probabilities or distributions. - Tests are model specific, so it is important to be clarify the exact model under consideration.
